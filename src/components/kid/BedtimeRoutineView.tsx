...
export function BedtimeRoutineView({ className }: Props) {
  return (
    <div
      className={cn(
        'fixed inset-0 z-[200] flex flex-col overflow-y-auto bg-gradient-to-b from-indigo-950 via-violet-950 to-zinc-950',
        className
      )}
      dir="rtl"
      role="main"
    ...
    >
      ...
      <div className="mx-auto w-full max-w-lg flex-1 px-3 py-4 pb-8 sm:px-4">
        <BedtimeRoutineZone />
      </div>
    </div>
  )
