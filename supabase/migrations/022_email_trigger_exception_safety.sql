-- Wrap email triggers in EXCEPTION WHEN OTHERS so email failures
-- never break user signup. Email is best-effort; auth must always succeed.
-- (Superseded by 023 which fixes the pg_net schema path.)
