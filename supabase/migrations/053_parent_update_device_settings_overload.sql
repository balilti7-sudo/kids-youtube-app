-- Re-apply single-signature parent_update_device_settings (safe if 051 already ran).
-- Fixes PostgREST: "Could not choose the best candidate function" when 2-arg and 4-arg overloads coexist.
...
REVOKE ALL ON FUNCTION public.parent_update_device_settings(UUID, BOOLEAN, INT, BOOLEAN) FROM PUBLIC;
